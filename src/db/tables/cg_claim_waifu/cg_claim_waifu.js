...
`, [userID, guildID, nsfw, rollWestern, rollGame, croppedImage, limitMultiplier, rollAnime, (isHusbando || 'NULL').toString()]);
...
`, [userID, guildID, nsfw, rollWestern, rollGame, croppedImage, rollAnime, (isHusbando || 'NULL').toString()]);
